...
extern int cinepak_decode_frame(int width, int height, const unsigned char* data, int data_size, 
                               unsigned char* output, int output_stride);
                                    ...
                                    if (cinepak_size >= 4) {
                                        ...
                                        if (frame_type == 0x20) {
                                            ...
                                            if (full_cinepak_frame) {
                                                ...
                                                if (cinepak_decode_frame(video_width, video_height, full_cinepak_frame, total_frame_size, 
                                                                       (unsigned char*)frame_buffer, video_width * 4) == 0) {
